...
| Kelimeler | `/languages/:courseSlug/words` | Kelime bankası. Her kayıtta CEFR seviye, IPA okunuş, ana dil okunuşu, ana dilde "nasıl okunur?" açıklaması, eş/zıt anlam, kelime kökü, tanım, örnek cümle, çeviri ve etiketler bulunur. **Yapay Zeka** ile otomatik kelime doldurma, kaydedilen öneriler için SQLite cache ve sesli telaffuz (Text-to-Speech) içerir. AI/cache sağlıklı sonuç vermezse düşük kaliteli sözlük/çeviri fallback'i kullanılmaz. |
